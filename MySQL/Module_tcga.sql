...
CREATE TABLE tcga_program(
    ...
    program_id              VARCHAR(110),
    name                    VARCHAR(255),
    dbgap_accession_number  VARCHAR(110),
...
CREATE TABLE tcga_tissue_source_site(
    id                      INTEGER     AUTO_INCREMENT,
    tissue_source_site_id  VARCHAR(110),
    code                    VARCHAR(110),
    bcr_id                  VARCHAR(110),
    name                    VARCHAR(110),
    project                 VARCHAR(110),
...
CREATE TABLE tcga_sample(
    id                      INTEGER     AUTO_INCREMENT,
    sample_id               VARCHAR(110),
    project_id              VARCHAR(110),
    submitter_id            VARCHAR(110),
    case_id                 VARCHAR(110),
    sample_type             VARCHAR(110),
    sample_type_id          INTEGER,
    composition             VARCHAR(110),
    current_weight          FLOAT,
    days_to_collection      INTEGER,
    days_to_sample_procurement  INTEGER,
    freezing_method         VARCHAR(110),
    initial_weight          FLOAT,
    intermediate_dimension  VARCHAR(110),
    is_ffpe                 VARCHAR(110),
    longest_dimension       VARCHAR(110),
    oct_embedded            VARCHAR(110),
    pathology_report_uuid   VARCHAR(110),
    preservation_method     VARCHAR(110),
    shortest_dimension      VARCHAR(110),
    time_between_clamping_and_freezing  VARCHAR(110),
    time_between_excision_and_freezing  VARCHAR(110),
    tissue_type             VARCHAR(110),
    tumor_code              VARCHAR(110),
    tumor_code_id           VARCHAR(110),
    tumor_descriptor        VARCHAR(110),
...
CREATE TABLE tcga_demographic (
    id                      INTEGER     AUTO_INCREMENT,
    demographic_id          VARCHAR(110),
    project_id              VARCHAR(110),
    submitter_id            VARCHAR(110),
    case_id                 VARCHAR(110),
    ethnicity               VARCHAR(110),
    gender                  VARCHAR(110),
    race                    VARCHAR(110),
...
CREATE TABLE tcga_diagnosis (
    id                          INTEGER     AUTO_INCREMENT,
    diagnosis_id                VARCHAR(110),
    project_id                  VARCHAR(110),
    submitter_id                VARCHAR(110),
    case_id                     VARCHAR(110),
    age_at_diagnosis            INTEGER,
    classification_of_tumor     VARCHAR(110),
    days_to_last_follow_up      INTEGER,
    days_to_last_known_disease_status   INTEGER,
    days_to_recurrence          INTEGER,
    last_known_disease_status   VARCHAR(110),
    morphology                  VARCHAR(255),
    primary_diagnosis           VARCHAR(255),
    progression_or_recurrence   VARCHAR(110),
    site_of_resection_or_biopsy VARCHAR(110),
    tissue_or_organ_of_origin   VARCHAR(110),
    tumor_grade                 VARCHAR(110),
    tumor_stage                 VARCHAR(110),
    vital_status                VARCHAR(110),
    days_to_birth               INTEGER,
    days_to_death               INTEGER,
    prior_malignancy            VARCHAR(110),
...
CREATE TABLE tcga_treatment (
    id                          INTEGER     AUTO_INCREMENT,
    treatment_id                VARCHAR(110),
    project_id                  VARCHAR(110),
    submitter_id                VARCHAR(110),
    diagnosis_id				VARCHAR(110),
    case_id                     VARCHAR(110),
    days_to_treatment           INTEGER,
    therapeutic_agents          VARCHAR(110),
    treatment_intent_type       VARCHAR(255),
    treatment_or_therapy        VARCHAR(110),
...
CREATE TABLE tcga_family_history (
    id                              INTEGER     AUTO_INCREMENT,
    family_history_id               VARCHAR(110),
    project_id                      VARCHAR(110),
    submitter_id                    VARCHAR(110),
    case_id                         VARCHAR(110),
    relationship_age_at_diagnosis   FLOAT,
    relationship_gender             VARCHAR(110),
    relationship_primary_diagnosis  VARCHAR(255),
    relationship_type               VARCHAR(110),
    relative_with_cancer_history    VARCHAR(110),
...
CREATE TABLE tcga_file_expression (
    ...
    submitter_id                    VARCHAR(110),
    case_id                         VARCHAR(110),
    data_category                   VARCHAR(110),
    data_format                     VARCHAR(110),
    data_type                       VARCHAR(110),
    experimental_strategy           VARCHAR(110),
    file_name                       VARCHAR(255),
    file_size                       INTEGER,
    md5sum                          VARCHAR(110),
    state_comment                   VARCHAR(110),
    comments                        VARCHAR(110),
